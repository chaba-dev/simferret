...
| link:0001/README.adoc[1: Deterministic execution architecture]
| Rust control plane, QEMU/TCG execution boundary, replay identity, and initial exclusions

| link:0002/README.adoc[2: Minimal deterministic simulation proof of concept]
| A bounded record/replay demonstration with a toy client, server, and controlled process failure
|===
